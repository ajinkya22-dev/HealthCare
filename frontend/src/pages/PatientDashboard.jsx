                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600">{dashboardData.doctor.specialization || 'General Physician'}</p>
                      ...
                      {allDoctors.slice(0, 5).map((doctor) => (
                        <div key={doctor._id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            />
                            <div>
                              <p className="font-medium text-gray-900">Dr. {doctor.name || doctor.userId?.name || 'Unknown'}</p>
                              <p className="text-sm text-gray-600">{doctor.specialization || 'General Physician'}</p>
                            </div>
                          </div>
                          <button 
                            onClick={() => navigate('/bookAppointment', { state: { doctor } })}
                            className="text-[#179fac] hover:text-[#147c88] text-sm font-medium"
                          >
                            Book
                          </button>
                        </div>
                    ...
                    <div key={appointment._id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">{appointment.description || 'No description'}</p>
                        </div>
